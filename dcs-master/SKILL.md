---
name: dcs-master
description: "协同开发平台统一技能。用于处理 DCS 项目初始化、GitLab 绑定、开发商标识、成员邀请、数据中心或环境关联、元数据或代码或 SQL 或静态资源构建、质量报告分析、构建失败或发布失败排障、天梯或私有云发布，以及经用户明确授权的浏览器协作操作。"
---
...
**每次加载本 skill 时，必须先执行版本检查**。如检测到新版本，在回复开头提示用户更新。

### 各工具版本检查命令

| 工具 | 检查命令 |
|------|----------|
| QoderWork | `python3 ~/.qoderwork/skills/dcs-master/scripts/version-check-wrapper.py` |
| Codex | `python3 ~/.codex/skills/dcs-master/scripts/version-check-wrapper.py` |
| OpenCode | `python3 .opencode/skills/dcs-master/scripts/version-check-wrapper.py` |
| Claude/Cursor/Copilot/Gemini | `python3 .dcs-master/scripts/version-check-wrapper.py` |

### 各工具升级命令

| 工具 | 升级命令 |
|------|----------|
| QoderWork | `python3 ~/.qoderwork/skills/dcs-master/scripts/upgrade-from-github.py qoderwork --to ~/.qoderwork/skills` |
| Codex | `python3 ~/.codex/skills/dcs-master/scripts/upgrade-from-github.py codex --to ~/.codex/skills` |
| OpenCode | `python3 .opencode/skills/dcs-master/scripts/upgrade-from-github.py opencode --to . --scope project` |
| Claude/Cursor/Copilot/Gemini | `python3 .dcs-master/scripts/upgrade-from-github.py universal --to .` |
